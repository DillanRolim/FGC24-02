...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Primeiro Triângulo
		drawTriangle(shaderID, VAO,vec3(100.0,300.0,0.0),vec3(100.0,100.0,1.0),0.0,vec3(0.0,0.0,1.0));

		//Segundo Triângulo
		drawTriangle(shaderID, VAO,vec3(350.0,300.0,0.0),vec3(200.0,200.0,1.0),180.0,vec3(0.0,1.0,0.0));
		
		//Terceiro Triângulo
		drawTriangle(shaderID, VAO,vec3(600.0,300.0,0.0),vec3(300.0,300.0,1.0),0.0,vec3(1.0,0.0,0.0));
