...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLE_FAN,0, nVertices); //Desenha os 2 triangulos preenchidos
		// Chamada de desenho - drawcall
		// Poligono Preenchido - GL_TRIANGLES

		glUniform4f(colorLoc, 1.0f, 0.0f, 1.0f, 1.0f); //enviando cor para variável uniform inputColor
		glDrawArrays(GL_LINE_LOOP,1, nVertices-2); //Desenha os 2 triangulos preenchidos

		glUniform4f(colorLoc, 0.0f, 1.0f, 1.0f, 1.0f); //enviando cor para variável uniform inputColor
		glDrawArrays(GL_POINTS,0, nVertices); //Desenha os 2 triangulos preenchidos
...
int createCircle(int nPoints, float radius)
{
	...
	//add ponto de origem (0.0,0.0,0.0) como centro
